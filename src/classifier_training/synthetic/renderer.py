...
def _contrasting_text_color(bg: tuple[int, int, int]) -> tuple[int, int, int]:
    ...
    if luminance > 128:
        # Dark text options for light backgrounds
        return random.choice(  # noqa: S311
            [(0, 0, 0), (0, 32, 78), (93, 14, 65), (30, 30, 30)]
        )
    else:
        # Light text options for dark backgrounds
        return random.choice(  # noqa: S311
            [(255, 255, 255), (253, 185, 39), (230, 230, 230)]
        )
...
class JerseyNumberRenderer:
    ...
    def render(self, label: str) -> Image.Image:
